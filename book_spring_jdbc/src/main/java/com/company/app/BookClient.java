...
public class BookClient {
	public static void main(String[] args) {
		...
		//새로운 도서 입력
//		BookDTO insertDto = new BookDTO("1015","돈까스","치즈돈까스",17000);
//		System.out.println(service.insertBook(insertDto)?"입력성공":"입력실패");
		
		//도서 정보 변경
//		System.out.println(service.updateBook("1011",15000)?"수정성공":"수정실패");
		
		//도서 정보 삭제
//		System.out.println(service.deleteBook("1015")?"삭제성공":"삭제실패");
